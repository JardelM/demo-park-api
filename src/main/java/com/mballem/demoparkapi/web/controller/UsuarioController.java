...
@Tag(name = "Usuarios", description = "Contém todas operações para cadastro, edição e leitura de um usuario")
...
public class UsuarioController {
    ...
    @GetMapping("/{id}")
    //autoriza acesso caso usuario cliente busque id dele mesmo apenas
