...
insert into CLIENTES (id, nome, cpf, id_usuario) values (30, 'ADMIN', '82825397083', 1500);
...
insert into CLIENTES_TEM_VAGAS (numero_recibo, placa, marca, modelo, cor, data_entrada, id_cliente, id_vaga)
    values ('20230315-101300', 'FIT-1020', 'FIAT', 'PALIO', 'VERDE', '2023-03-15 10:13:00', 30, 40);